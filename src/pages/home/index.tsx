  ...
  return (
    <main>
      <section className="px-6 pt-4 pb-10 sm:px-10">
        <div className="mx-auto hyphens-auto max-w-[58rem] text-justify text-2xl leading-relaxed text-gray-800 dark:text-gray-200">
          <p>
      ...
      <section className="px-6 py-8 sm:px-10">
        <div className="mx-auto max-w-[58rem]">
          ...
          {/* Two across: four short entries down one side left half of it empty. */}
          <ul className="mt-3 grid gap-x-12 gap-y-1 sm:grid-cols-2">
